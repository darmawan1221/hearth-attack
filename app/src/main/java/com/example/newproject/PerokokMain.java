...
public class PerokokMain extends AppCompatActivity {
    ...
    ListAdapter adapter;
    ArrayList<HashMap<String, String>> perokokList;
    ArrayList checkList;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        perokokList = new ArrayList<>();
        checkList = new ArrayList<>();
        mPref = new SharedPrefManager(this);
        lv = (ListView) findViewById(R.id.list);
        intent = new Intent(PerokokMain.this,Category_Main.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPref.save_array("smoking",list);
                Toast.makeText(getApplicationContext(), "TERSIMPAN "+mPref.get_array("smoking").toString(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PerokokMain.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        if(c.getString("description").equalsIgnoreCase("Merokok")){
