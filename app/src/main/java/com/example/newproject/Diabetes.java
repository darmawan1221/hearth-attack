...
public class Diabetes extends AppCompatActivity {
    ...
    ListAdapter adapter;
    ArrayList<HashMap<String, String>> diabetesList;
    ArrayList checkList;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diabetesList = new ArrayList<>();
        checkList = new ArrayList<>();

        lv = (ListView) findViewById(R.id.list);
        intent = new Intent(Diabetes.this,Recomend.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPref.save_array("diabetes",list);
                Toast.makeText(getApplicationContext(), "TERSIMPAN "+mPref.get_array("diabetes").toString(), Toast.LENGTH_SHORT).show();
                finish();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Diabetes.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        if(c.getString("description").equalsIgnoreCase("diabetes")){
