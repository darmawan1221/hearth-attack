...
public class Kolesterol extends AppCompatActivity {
    ...
    private String TAG = Kolesterol.class.getSimpleName();
    ...
    ListAdapter adapter;
    ArrayList<HashMap<String, String>> kolesterolList;
    ArrayList checkList;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kolesterolList = new ArrayList<>();
        checkList = new ArrayList<>();

        lv = (ListView) findViewById(R.id.list);
        intent = new Intent(Kolesterol.this,Recomend.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            mPref.save_array("cholesterol",list);
            Toast.makeText(getApplicationContext(), "TERSIMPAN "+mPref.get_array("cholesterol").toString(), Toast.LENGTH_SHORT).show();
            finish();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Kolesterol.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        if(c.getString("description").equalsIgnoreCase("kolesterol")){
